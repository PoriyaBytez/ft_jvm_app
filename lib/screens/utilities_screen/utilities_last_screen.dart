...
class UtilitiesLastScreen extends StatefulWidget {
  ...
  UtilitiesLastScreen({Key? key, this.categoryId, this.subCategoryId})
      : super(key: key);
...
class _UtilitiesLastScreenState extends State<UtilitiesLastScreen> {
  ...
  void initState() {
    ...
    utilitiesDetailController.getUtilitiesData({
      ...
      "category_id": widget.categoryId, // widget.categoryId,
      "sub_category": widget.subCategoryId, //widget.subCategoryId,
    });
    super.initState();
  }
      ...
      body: Container(
        ...
        child: Column(
          children: [
                                      ...
                                      child: Obx(() => cityController
                                          ...
                                          : RawScrollbar(
                                              ...
                                              child: ListView.builder(
                                                itemCount: searchCityController
                                                        .text.isNotEmpty
                                                    ? cityController
                                                ...
                                                itemBuilder: (context, index) {
                                                  ...
                                                  return GestureDetector(
                                                    onTap: () {
                                                      ...
                                                      for (int i = 0;
                                                          i <
                                                              utilitiesDetailController
                                                                  .utilitiesList
                                                                  .length;
                                                          i++) {
                                                        if (utilitiesDetailController
                                                            .utilitiesList[i]
                                                            .cityId
                                                            .contains(itemName
                                                                .id
                                                      ...
                                                      //   print("itemName.id ==> ${itemName.id.toString()}");
                                                      //   print("utilitiesDetailController ==> ${utilitiesDetailController.utilitiesList[i].cityId.toString()}");
                                                      //   if (itemName.id.toString() == utilitiesDetailController.utilitiesList[i].cityId.toString()) {
                                                      //     print("itemName.id ==> ${itemName.id.toString()}");
            ...
            Expanded(
                child: Obx(
              () => utilitiesDetailController.utilitiesList.isEmpty
